...
- Screenshot path: reports/low_vision_batch/visual/low_vision_sample/page.png
- Focus path overlay path: reports/low_vision_batch/visual/low_vision_sample/focus_path.html
