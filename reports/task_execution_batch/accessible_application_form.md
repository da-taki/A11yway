...
- Screenshot path: reports/task_execution_batch/visual/accessible_application_form/page.png
- Focus path overlay path: reports/task_execution_batch/visual/accessible_application_form/focus_path.html
